...
if (!isset($_SESSION["Username"])) {
  header("Location: http://localhost/Assignment-2/login.php");
  exit();
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="top-right"><h1>FRONT-END DEVELOPER!</h1>
        <p>A front end developer and Graphic Designer.</p>
        <center><button><a href=" ">Download CV</a></button></div></center>
    </div>
